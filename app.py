...
def home():
    ...
    # Text with size 100
    st.markdown("<h2 class='st-centered' style='color: #5BEAB1;'>A Farm management system</h2>", unsafe_allow_html=True)
...
# Sidebar navigation
menu_options = ["Home", "Field Mapping", "Crop Planning", "Crop History","Crop recommendation","Plant disease prediction",
...
if selected_menu == "Home":
    ...
    crop_recommendation()
elif selected_menu == "Plant disease prediction":
...
menu_options = st.sidebar.multiselect("Select options:", ["Home", "Field Mapping", "Crop Planning",
                                                          "Crop History", "Crop recommendation","Plant disease prediction",
                                                          "Pest Management","Weather Tracking", "Irrigation Management"])
...
if "Crop History" in menu_options:
    crop_history()
if "Crop recommendation" in menu_options:
    crop_recommendation()
if "Plant disease prediction" in menu_options:
     plant_disease_prediction()
